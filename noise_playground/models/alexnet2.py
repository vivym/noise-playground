...
from torchvision.models.alexnet import alexnet as _alexnet, AlexNet_Weights
...
def alexnet(*, weights = None, progress: bool = True, **kwargs):
    model = _alexnet(weights=weights, progress=progress, **kwargs)
